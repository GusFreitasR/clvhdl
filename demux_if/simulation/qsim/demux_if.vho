...
ARCHITECTURE structure OF demux_if IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \a~0_combout\ = (\x~input_o\ & (!\sel[1]~input_o\ & !\sel[0]~input_o\))
...
-- Equation(s):
-- \Equal2~0_combout\ = (\x~input_o\ & (!\sel[1]~input_o\ & \sel[0]~input_o\))
...
-- Equation(s):
-- \Equal2~1_combout\ = (\x~input_o\ & (\sel[1]~input_o\ & !\sel[0]~input_o\))
...
-- Equation(s):
-- \Equal2~2_combout\ = (\x~input_o\ & (\sel[1]~input_o\ & \sel[0]~input_o\))
